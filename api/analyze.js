...
const KNOWN_SERVICES = [
  ...
  {
    pattern: /youtube\s?(premium|music)/i,
    name: 'YouTube Premium',
    category: 'streaming',
    avgCost: 11.99,
  },
  {
    pattern: /youtube\s?tv/i,
    name: 'YouTube TV',
    category: 'streaming',
    avgCost: 72.99,
  },
  ...
  {
    pattern: /apple\s?(tv|music)/i,
    name: 'Apple TV+',
    category: 'streaming',
    avgCost: 6.99,
  },
  {
    pattern: /amazon\s?prime|prime\s?video/i,
    name: 'Amazon Prime',
    category: 'streaming',
    avgCost: 8.99,
  },
  {
    pattern: /paramount\+|paramountplus/i,
    name: 'Paramount+',
    category: 'streaming',
    avgCost: 9.99,
  },
  ...
  // Telecom - Greek
  {
    pattern: /cosmote|κοσμοτε|ote/i,
    name: 'Cosmote',
    category: 'telecom',
    avgCost: 35.0,
  },
  {
    pattern: /vodafone|vodaf/i,
    name: 'Vodafone',
    category: 'telecom',
    avgCost: 30.0,
  },
  {
    pattern: /wind\s?(hellas)?/i,
    name: 'Wind',
    category: 'telecom',
    avgCost: 25.0,
  },
  {
    pattern: /nova|forthnet/i,
    name: 'Nova',
    category: 'telecom',
    avgCost: 40.0,
  },
  ...
  // AI & Developer Tools
  {
    pattern: /chatgpt|openai|gpt\s?plus/i,
    name: 'ChatGPT Plus',
    category: 'software',
    avgCost: 20.0,
  },
  {
    pattern: /claude\s?pro|anthropic/i,
    name: 'Claude Pro',
    category: 'software',
    avgCost: 20.0,
  },
  ...
  {
    pattern: /github\s?copilot/i,
    name: 'GitHub Copilot',
    category: 'software',
    avgCost: 10.0,
  },
  { pattern: /replit/i, name: 'Replit', category: 'software', avgCost: 20.0 },
  { pattern: /cursor/i, name: 'Cursor', category: 'software', avgCost: 20.0 },
  {
    pattern: /elevenlabs/i,
    name: 'ElevenLabs',
    category: 'software',
    avgCost: 22.0,
  },
  { pattern: /railway/i, name: 'Railway', category: 'software', avgCost: 5.0 },
  { pattern: /vercel/i, name: 'Vercel', category: 'software', avgCost: 20.0 },

  // Productivity Software
  {
    pattern: /microsoft|office\s?365|ms\s?365/i,
    name: 'Microsoft 365',
    category: 'software',
    avgCost: 10.0,
  },
  ...
  {
    pattern: /google\s?(one|storage|workspace)/i,
    name: 'Google One',
    category: 'software',
    avgCost: 2.99,
  },
  ...
  { pattern: /notion/i, name: 'Notion', category: 'software', avgCost: 8.0 },
  {
    pattern: /canva/i,
    name: 'Canva Pro',
    category: 'software',
  ...
  { pattern: /todoist/i, name: 'Todoist', category: 'software', avgCost: 4.0 },
  {
    pattern: /evernote/i,
    name: 'Evernote',
    category: 'software',
  ...
  {
    pattern: /linkedin\s?premium/i,
    name: 'LinkedIn Premium',
    category: 'software',
    avgCost: 29.99,
  },
  {
    pattern: /x\s?premium|twitter\s?blue/i,
    name: 'X Premium',
    category: 'software',
    avgCost: 8.0,
  },
  {
    pattern: /discord\s?nitro/i,
    name: 'Discord Nitro',
    category: 'software',
    avgCost: 9.99,
  },
  ...
  // News & Media
  {
    pattern: /ny\s?times|nytimes/i,
    name: 'New York Times',
    category: 'news',
    avgCost: 17.0,
  },
  {
    pattern: /wsj|wall\s?street\s?journal/i,
    name: 'Wall Street Journal',
    category: 'news',
    avgCost: 38.99,
  },
  {
    pattern: /washington\s?post|wapo/i,
  ...
  { pattern: /substack/i, name: 'Substack', category: 'news', avgCost: 5.0 },
  { pattern: /medium/i, name: 'Medium', category: 'news', avgCost: 5.0 },

  // Fitness & Gym
  { pattern: /equinox/i, name: 'Equinox', category: 'gym', avgCost: 200.0 },
  {
    pattern: /24\s?hour\s?fitness/i,
  ...
  {
    pattern: /la\s?fitness/i,
    name: 'LA Fitness',
    category: 'gym',
    avgCost: 34.99,
  },
  {
    pattern: /anytime\s?fitness/i,
    name: 'Anytime Fitness',
    category: 'gym',
    avgCost: 41.99,
  },
  { pattern: /classpass/i, name: 'ClassPass', category: 'gym', avgCost: 79.0 },
  { pattern: /peloton/i, name: 'Peloton', category: 'gym', avgCost: 44.0 },
  {
    pattern: /holmes\s?place/i,
    name: 'Holmes Place',
    category: 'gym',
    avgCost: 85.0,
  },
  { pattern: /mcfit|mc\s?fit/i, name: 'McFit', category: 'gym', avgCost: 24.9 },
  {
    pattern: /gold'?s?\s?gym/i,
    name: "Gold's Gym",
    category: 'gym',
    avgCost: 45.0,
  },
  {
    pattern: /gym|γυμναστ/i,
    name: 'Γυμναστήριο',
    category: 'gym',
    avgCost: 35.0,
  },
  ...
  // Utilities - Greek
  { pattern: /δεη|dei|ppc/i, name: 'ΔΕΗ', category: 'utility', avgCost: 80.0 },
  {
    pattern: /ευδαπ|eydap/i,
    name: 'ΕΥΔΑΠ',
    category: 'utility',
    avgCost: 25.0,
  },
  {
    pattern: /δεπα|depa|φυσικο\s?αεριο/i,
    name: 'Φυσικό Αέριο',
    category: 'utility',
    avgCost: 50.0,
  },
  ...
  {
    pattern: /uber\s?eats\s?pass/i,
    name: 'Uber Eats Pass',
    category: 'food',
    avgCost: 9.99,
  },
  {
    pattern: /wolt\+|wolt\s?plus/i,
    name: 'Wolt+',
    category: 'food',
    avgCost: 5.99,
  },
  {
    pattern: /efood\s?plus/i,
    name: 'efood Plus',
    category: 'food',
    avgCost: 3.99,
  },
  {
    pattern: /doordash\s?pass/i,
    name: 'DoorDash DashPass',
    category: 'food',
    avgCost: 9.99,
  },
  {
    pattern: /grubhub\+|grubhub\s?plus/i,
    name: 'Grubhub+',
    category: 'food',
    avgCost: 9.99,
  },
  {
    pattern: /lyft\s?pink/i,
    name: 'Lyft Pink',
    category: 'transportation',
    avgCost: 9.99,
  },
  {
    pattern: /deliveroo\s?plus/i,
    name: 'Deliveroo Plus',
    category: 'food',
    avgCost: 7.99,
  },
  ...
  {
    pattern: /playstation|ps\s?(plus|now)/i,
    name: 'PlayStation Plus',
    category: 'other',
    avgCost: 8.99,
  },
  {
    pattern: /xbox\s?(live|game\s?pass)/i,
    name: 'Xbox Game Pass',
    category: 'other',
    avgCost: 12.99,
  },
  ...
  {
    pattern: /epic\s?games/i,
    name: 'Epic Games',
    category: 'gaming',
    avgCost: 0,
  },
  { pattern: /twitch/i, name: 'Twitch', category: 'streaming', avgCost: 4.99 },
  { pattern: /patreon/i, name: 'Patreon', category: 'other', avgCost: 10.0 },
  { pattern: /onlyfans/i, name: 'OnlyFans', category: 'other', avgCost: 15.0 },
  ...
  // Insurance - Greek
  {
    pattern: /interamerican/i,
    name: 'Interamerican',
    category: 'other',
    avgCost: 50.0,
  },
  { pattern: /eurolife/i, name: 'Eurolife', category: 'other', avgCost: 45.0 },
  { pattern: /generali/i, name: 'Generali', category: 'other', avgCost: 40.0 },
  {
    pattern: /nn\s?hellas/i,
    name: 'NN Hellas',
    category: 'other',
    avgCost: 55.0,
  },
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (fileExt === 'csv') {
      ...
      transactions = data.map((row) => {
        ...
        const desc =
          ...
          row['περιγραφή'] ||
          row['description'] ||
          Object.values(row).find((v) => typeof v === 'string' && v.length > 5);
        const date =
          row['Ημερομηνία'] ||
          row['Date'] ||
          row['Ημ/νία'] ||
    ...
    console.log(
      'Service occurrences:',
      Array.from(serviceOccurrences.entries()).map(
        ([name, txs]) => `${name}: ${txs.length} times`
      )
    );
    ...
    serviceOccurrences.forEach((occurrences, serviceName) => {
      ...
      console.log(
        `${serviceName}: appears in ${uniqueMonths} different months`
      );

      if (uniqueMonths < 2) {
        console.log(
          `  ✗ ${serviceName}: only appears in 1 month - not a subscription`
        );
        return; // Skip - must appear in at least 2 different months
      }

      // Get all non-zero costs
      const costs = occurrences
      ...
      if (costs.length >= 2) {
        ...
        console.log(
          `  → avg=€${avgCost.toFixed(2)}, CV=${coefficientOfVariation.toFixed(
            1
          )}%`
        );
        ...
        if (coefficientOfVariation > 10) {
          console.log(
            `  ✗ ${serviceName}: price varies too much (${coefficientOfVariation.toFixed(
              1
            )}%) - not a subscription`
          );
          ...
          console.log(
            `  ✓ ${serviceName}: consistent price - IS a subscription`
          );
        }
      }
    ...
    transactions.forEach((t) => {
      ...
      const alreadyMatched = Array.from(serviceOccurrences.keys()).some(
        (serviceName) => {
          return serviceOccurrences
            .get(serviceName)
            .some((knownTx) => knownTx.description === t.description);
        }
      );
    ...
    unknownCharges.forEach((occurrences, description) => {
      ...
      console.log(
        `Unknown: "${description.substring(
          0,
          50
        )}..." - appears in ${uniqueMonths} different months`
      );
      ...
      if (coefficientOfVariation < 10) {
        console.log(
          `  ✓ Consistent price - flagging as potential subscription`
        );
        ...
        console.log(
          `  ✗ Price varies too much (${coefficientOfVariation.toFixed(
            1
          )}%) - skipping`
        );
      }
    ...
    const unknownCount = Array.from(foundSubscriptions.values()).filter(
      (s) => s.needsConfirmation
    ).length;
...
function parseCSV(content) {
  ...
  const descIndex = headers.findIndex(
    (h) =>
      h.includes('περιγραφή') ||
      h.includes('description') ||
      h.includes('αιτιολογία') ||
      h.includes('details')
  );
...
function parsePDFText(text) {
  ...
  for (const line of lines) {
    // Skip header lines
    if (
      line.toLowerCase().includes('ημερομηνία') ||
